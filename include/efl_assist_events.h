...
/**
 * @internal
 * @defgroup EFL_Assist_Events_Group Efl Assist Event
 ...
 *
 * @details This function adds a function callback to an object when the key event
 ...
 *
 * @remarks A callback function must have the Ea_Event_Cb prototype definition.
